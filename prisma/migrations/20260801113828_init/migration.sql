-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'INVENTORY_MANAGER', 'STORE_MANAGER', 'SALES_STAFF');
...
-- CreateEnum
CREATE TYPE "PurchaseOrderStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'RECEIVED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LOW_STOCK', 'SUCCESS', 'WARNING', 'INFO');
...
CREATE TABLE "CompanySettings" (
    "id" TEXT NOT NULL,
    "companyName" TEXT NOT NULL DEFAULT 'Smart Inventory Management System',
    "email" TEXT,
    "phone" TEXT,
    "address" TEXT,
    "logo" TEXT,
